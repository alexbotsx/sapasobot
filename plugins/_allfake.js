...
handler.all = async function (m) {
    ...
    //creador y otros
    global.creador = 'Wa.me/51968914403 '
    global.ofcbot = `${conn.user.jid.split('@')[0]}`
    global.asistencia = 'https://wa.me/qr/PAOHAKCEHGUXN1'
    global.namechannel = '@SAPITOBOT'
    ...
    //Emojis determinado de SAPITOBOT Bot
    global.emoji = '🍁'
    global.emoji2 = '⭐'
    global.emoji3 = '✨️'
    global.emoji4 = '😴'
    ...
    // global.estilo = { key: {  fromMe: false, participant: `0@s.whatsapp.net`, ...(false ? { remoteJid: "51968914403 -1625305606@g.us" } : {}) }, message: { orderMessage: { itemCount : -999999, status: 1, surface : 1, message: `${packname}`, orderTitle: 'Bang', thumbnail: icons, sellerJid: '0@s.whatsapp.net'}}}
    ...
    global.icono = [
        'https://ibb.co/7N8yHZ2q/avatar-contact.jpg',
        'https://ibb.co/7N8yHZ2q/avatar-contact.jpg',
        'https://ibb.co/7N8yHZ2q/avatar-contact.jpg'
    ].getRandom()
